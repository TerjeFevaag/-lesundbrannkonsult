    ...
    <div className="bg-brand-dark text-brand-white text-sm py-2">
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center gap-6">
          ...
          <a href="mailto:post@alesundbrannkonsult.no" className="hidden sm:flex items-center gap-2 hover:text-brand-orange transition-colors">
            <Mail size={14} /><span>post@alesundbrannkonsult.no</span>
          </a>
        </div>
