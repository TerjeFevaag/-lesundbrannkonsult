                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:post@alesundbrannkonsult.no" className="text-brand-white font-bold hover:text-brand-orange transition-colors break-all">post@alesundbrannkonsult.no</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
